...
---|---|---|---|---
[30. 包含min函数的栈](30.cpp)|简单|单调栈，T=O(n)，S=O(n)
---|---|---|---|---
[59 - I. 滑动窗口的最大值](59_1.cpp)|中等|单调队列，T=O(n)，S=O(n)
[59 - II. 队列的最大值](59_2.cpp)|中等|单调队列，T=O(n)，S=O(n)
...
题目|难度|方法1|方法2|方法3
---|---|---|---|---
[43. 1～n 整数中 1 出现的次数](43.cpp)|困难|递归法，T=O(logn)
...
[17. 打印从1到最大的n位数](17.cpp)|简单|dfs，全排列
...
[49. 丑数](49.cpp)|中等|DP，T=O(n), S=O(n)||后面的丑数可以由前面的丑数乘以2, 3, 5推导得到
...
题目|难度|方法1|方法2|方法3
---|---|---|---|---
[64. 求1+2+…+n](64.cpp)|中等|静态成员变量+构造函数|逻辑运算符的短路效应+递归
